...
if (!isset($_SESSION['adminadmin'])) {
    ...
    if (isset($_POST['approveBtn'])) {
        ...
        $status = 'Approved';
        $remarks = " ";
        $sql = "update staff set status=:status,comment=:remarks WHERE serial=:idi";
    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                ...
                <i class="fa fa-dashboard"></i> Dashboard / View Inventory Manager
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h3 class="panel-title">
                    ...
                    <i class="fa fa-money fa-fw"></i> View Inventory Manager
                    ...
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                $get_c = "SELECT * from staff where role='Inventory' order by status asc";
